...
from vnpy.trader.ui import QtCore, QtWidgets, QtGui, SETTINGS
...
class BacktesterManager(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.class_combo.setStyleSheet(f"QComboBox::item:checked{{font-weight: bold; height: {fontsize}px;}}")

        self.symbol_line = QtWidgets.QLineEdit("IF88.CFFEX")

        self.interval_combo = QtWidgets.QComboBox()
        self.interval_combo.setStyleSheet(f"QComboBox::item:checked{{font-weight: bold; height: {fontsize}px;}}")
        ...
        self.inverse_combo.setStyleSheet(f"QComboBox::item:checked{{font-weight: bold; height: {fontsize}px;}}")
